...
RUN wget https://github.com/prusa3d/PrusaSlicer/releases/download/version_2.7.2/PrusaSlicer-2.7.2+linux-x64-GTK2-202402291326.tar.bz2 -O prusaslicer.tar.bz2
